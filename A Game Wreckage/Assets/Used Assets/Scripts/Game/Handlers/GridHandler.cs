...
public class GridHandler : MonoBehaviour
{
    ...
    public void GenerateGrid()
    {
        ...
        tilemap.Load("map_" + GameHandler.Instance.map);
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(1))
        {
            ...
            base1.UI.SetActive(false);
            base2.UI.SetActive(false);
        }
    ...
    IEnumerator DelayedAttack(float delayTime, BaseUnit t, BaseUnit u)
    {
        ...
        //t.health.SetHealth(t.hp);
        t.transform.Find("Canvas").transform.Find("HealthBar").GetComponent<HealthBar>().SetHealth(t.hp);
